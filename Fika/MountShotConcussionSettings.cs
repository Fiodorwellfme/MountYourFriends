...
namespace MountYourFriendsFika
{
    internal static class MountShotConcussionSettings
    {
        ...
        internal static float MaxDoubleVisionAmount;
        internal static float MaxWiggleSpeed;
        internal static float MaxWiggleScale;
        internal static float MaxWiggleStrength;
        internal static float MaxMotionBlurAmount;
        ...
        internal static void Init(ConfigFile config)
        {
            ...
            ConfigEntries.Add(MaxAudibleDistanceMeters = config.Bind("Concussion", "Max Audible Distance", 400f,
                new ConfigDescription(
            ...
            ConfigEntries.Add(MinimumDurationSeconds = config.Bind("Concussion", "Minimum Duration", 2f,
                new ConfigDescription(
                    "Minimum total concussion duration.",
                    new AcceptableValueRange<float>(0f, 120f),
                    new global::ConfigurationManagerAttributes { IsAdvanced = true, ShowRangeAsPercent = false })));

            ConfigEntries.Add(MaximumDurationSeconds = config.Bind("Concussion", "Maximum Duration", 10f,
                new ConfigDescription(
                    "Maximum total concussion duration.",
                    new AcceptableValueRange<float>(0f, 120f),
                    new global::ConfigurationManagerAttributes { IsAdvanced = true, ShowRangeAsPercent = false })));

            ConfigEntries.Add(MinimumIntensity = config.Bind("Concussion", "Minimum Intensity", 0.05f,
                new ConfigDescription(
                    "Minimum total concussion intensity.",
                    new AcceptableValueRange<float>(0f, 50f),
                    new global::ConfigurationManagerAttributes { IsAdvanced = true, ShowRangeAsPercent = false })));

            ConfigEntries.Add(MaximumIntensity = config.Bind("Concussion", "Maximum Intensity", 10f,
                new ConfigDescription(
                    "Maximum total concussion intensity.",
                    new AcceptableValueRange<float>(0f, 50f),
                    new global::ConfigurationManagerAttributes { IsAdvanced = true, ShowRangeAsPercent = false })));

            ConfigEntries.Add(MinimumDurationIncreasePerShotSeconds = config.Bind("Concussion", "Minimum Duration Increase Per Shot", 0.5f,
                new ConfigDescription(
                    "Minimum duration added by each shot before protection reduction.",
                    new AcceptableValueRange<float>(0f, 30f),
                    new global::ConfigurationManagerAttributes { IsAdvanced = true, ShowRangeAsPercent = false })));

            ConfigEntries.Add(MaximumDurationIncreasePerShotSeconds = config.Bind("Concussion", "Maximum Duration Increase Per Shot", 2f,
                new ConfigDescription(
                    "Maximum duration added by each shot before protection reduction.",
                    new AcceptableValueRange<float>(0f, 30f),
                    new global::ConfigurationManagerAttributes { IsAdvanced = true, ShowRangeAsPercent = false })));

            ConfigEntries.Add(MinimumIntensityIncreasePerShot = config.Bind("Concussion", "Minimum Intensity Increase Per Shot", 0.1f,
                new ConfigDescription(
                    "Minimum intensity added by each shot before protection reduction.",
                    new AcceptableValueRange<float>(0f, 10f),
                    new global::ConfigurationManagerAttributes { IsAdvanced = true, ShowRangeAsPercent = false })));

            ConfigEntries.Add(MaximumIntensityIncreasePerShot = config.Bind("Concussion", "Maximum Intensity Increase Per Shot", 1f,
                new ConfigDescription(
                    "Maximum intensity added by each shot before protection reduction.",
                    new AcceptableValueRange<float>(0f, 10f),
                    new global::ConfigurationManagerAttributes { IsAdvanced = true, ShowRangeAsPercent = false })));

            ConfigEntries.Add(CaliberAudibleDistances["20x1mm"] = config.Bind("Concussion Calibers", "20x1mm disk (Blicky)", 5000f, CaliberDescription()));
            ConfigEntries.Add(CaliberAudibleDistances["9x18PM"] = config.Bind("Concussion Calibers", "9x18 mm", 110f, CaliberDescription()));
            ConfigEntries.Add(CaliberAudibleDistances["9x19PARA"] = config.Bind("Concussion Calibers", "9x19mm Parabellum", 110f, CaliberDescription()));
            ConfigEntries.Add(CaliberAudibleDistances["46x30"] = config.Bind("Concussion Calibers", "4.6 x 30mm", 120f, CaliberDescription()));
            ConfigEntries.Add(CaliberAudibleDistances["9x21"] = config.Bind("Concussion Calibers", "9x21mm Gyurza", 120f, CaliberDescription()));
            ConfigEntries.Add(CaliberAudibleDistances["57x28"] = config.Bind("Concussion Calibers", "5.7 x 28 mm", 120f, CaliberDescription()));
            ConfigEntries.Add(CaliberAudibleDistances["762x25TT"] = config.Bind("Concussion Calibers", "7.62 x 25 mm Tokarev", 120f, CaliberDescription()));
            ConfigEntries.Add(CaliberAudibleDistances["1143x23ACP"] = config.Bind("Concussion Calibers", ".45 ACP", 115f, CaliberDescription()));
            ConfigEntries.Add(CaliberAudibleDistances["9x33R"] = config.Bind("Concussion Calibers", ".357 Magnum", 125f, CaliberDescription()));
            ConfigEntries.Add(CaliberAudibleDistances["545x39"] = config.Bind("Concussion Calibers", "5.45 x 39 mm", 160f, CaliberDescription()));
            ConfigEntries.Add(CaliberAudibleDistances["556x45NATO"] = config.Bind("Concussion Calibers", "5.56 x 45 mm", 160f, CaliberDescription()));
            ConfigEntries.Add(CaliberAudibleDistances["9x39"] = config.Bind("Concussion Calibers", "9x39mm", 160f, CaliberDescription()));
            ConfigEntries.Add(CaliberAudibleDistances["762x35"] = config.Bind("Concussion Calibers", ".300 Blackout", 175f, CaliberDescription()));
            ConfigEntries.Add(CaliberAudibleDistances["762x39"] = config.Bind("Concussion Calibers", "7.62 x 39 mm", 175f, CaliberDescription()));
            ConfigEntries.Add(CaliberAudibleDistances["366TKM"] = config.Bind("Concussion Calibers", ".366 TKM", 175f, CaliberDescription()));
            ConfigEntries.Add(CaliberAudibleDistances["762x51"] = config.Bind("Concussion Calibers", "7.62 x 51 mm", 200f, CaliberDescription()));
            ConfigEntries.Add(CaliberAudibleDistances["127x55"] = config.Bind("Concussion Calibers", "12.7x55mm", 200f, CaliberDescription()));
            ConfigEntries.Add(CaliberAudibleDistances["762x54R"] = config.Bind("Concussion Calibers", "7.62 x 54 mm R", 225f, CaliberDescription()));
            ConfigEntries.Add(CaliberAudibleDistances["86x70"] = config.Bind("Concussion Calibers", ".338 Lapua Magnum", 250f, CaliberDescription()));
            ConfigEntries.Add(CaliberAudibleDistances["20g"] = config.Bind("Concussion Calibers", "20 gauge", 185f, CaliberDescription()));
            ConfigEntries.Add(CaliberAudibleDistances["12g"] = config.Bind("Concussion Calibers", "12 gauge", 185f, CaliberDescription()));
            ConfigEntries.Add(CaliberAudibleDistances["23x75"] = config.Bind("Concussion Calibers", "23 x 75 mm (KS-23)", 210f, CaliberDescription()));
            ConfigEntries.Add(CaliberAudibleDistances["26x75"] = config.Bind("Concussion Calibers", "Flare Shell", 50f, CaliberDescription()));
            ConfigEntries.Add(CaliberAudibleDistances["30x29"] = config.Bind("Concussion Calibers", "30x29mm VOG-30", 50f, CaliberDescription()));
            ConfigEntries.Add(CaliberAudibleDistances["40x46"] = config.Bind("Concussion Calibers", "40x46mm", 50f, CaliberDescription()));
            ConfigEntries.Add(CaliberAudibleDistances["40mmRU"] = config.Bind("Concussion Calibers", "40mm VOG-25", 50f, CaliberDescription()));
            ConfigEntries.Add(CaliberAudibleDistances["127x99"] = config.Bind("Concussion Calibers", ".50 BMG", 275f, CaliberDescription()));
            ConfigEntries.Add(CaliberAudibleDistances["127x108"] = config.Bind("Concussion Calibers", "12.7x108mm", 300f, CaliberDescription()));
            ConfigEntries.Add(CaliberAudibleDistances["725"] = config.Bind("Concussion Calibers", "RShG-2 72.5mm rocket launcher", 400f, CaliberDescription()));
            ConfigEntries.Add(CaliberAudibleDistances["1036x77"] = config.Bind("Concussion Calibers", ".408 Cheyenne Tactical", 250f, CaliberDescription()));
            ConfigEntries.Add(CaliberAudibleDistances["11x33R"] = config.Bind("Concussion Calibers", ".44 Magnum", 150f, CaliberDescription()));
            ConfigEntries.Add(CaliberAudibleDistances["25x59"] = config.Bind("Concussion Calibers", "25x59 mm", 250f, CaliberDescription()));
            ConfigEntries.Add(CaliberAudibleDistances["762x67B"] = config.Bind("Concussion Calibers", ".300 Winchester Magnum", 200f, CaliberDescription()));
            ConfigEntries.Add(CaliberAudibleDistances["784x49"] = config.Bind("Concussion Calibers", ".308 Marlin Express", 200f, CaliberDescription()));
            ConfigEntries.Add(CaliberAudibleDistances["792x57"] = config.Bind("Concussion Calibers", "7.92x57mm Mauser", 225f, CaliberDescription()));
            ConfigEntries.Add(CaliberAudibleDistances["86x43"] = config.Bind("Concussion Calibers", "8.6mm Blackout", 200f, CaliberDescription()));
            ConfigEntries.Add(CaliberAudibleDistances["86x63"] = config.Bind("Concussion Calibers", ".338 Norma Magnum", 250f, CaliberDescription()));
            ConfigEntries.Add(CaliberAudibleDistances["93x64"] = config.Bind("Concussion Calibers", "9.3x64mm Brenneke", 240f, CaliberDescription()));
            ConfigEntries.Add(CaliberAudibleDistances["68x51"] = config.Bind("Concussion Calibers", "6.8x51mm SIG", 200f, CaliberDescription()));

            ConfigEntries.Add(LowMuteReduction = config.Bind("Concussion Protection", "Low Mute Reduction", 0.35f,
            ...
            ConfigEntries.Add(StrongMuteReduction = config.Bind("Concussion Protection", "Strong Mute Reduction", 0.65f,
            ...
            ConfigEntries.Add(SuppressorLoudnessReductionMultiplier = config.Bind("Concussion Protection", "Suppressor Loudness Reduction Multiplier", 1f,
            ...
            ConfigEntries.Add(GunsCompressorHighLevel = config.Bind("Concussion Protection", "Guns Compressor High Level", 0f,
            ...
            ConfigEntries.Add(GunsCompressorLowLevel = config.Bind("Concussion Protection", "Guns Compressor Low Level", -14f,
            ...
            ConfigEntries.Add(MaxDoubleVisionAmountEntry = config.Bind("Concussion Visuals", "Max Double Vision Amount", 1f,
            ...
            ConfigEntries.Add(MaxWiggleSpeedEntry = config.Bind("Concussion Visuals", "Max Wiggle Speed", 50f,
            ...
            ConfigEntries.Add(MaxWiggleScaleEntry = config.Bind("Concussion Visuals", "Max Wiggle Scale", 4f,
            ...
            ConfigEntries.Add(MaxWiggleStrengthEntry = config.Bind("Concussion Visuals", "Max Wiggle Strength", 0.8f,
            ...
            ConfigEntries.Add(MaxMotionBlurAmountEntry = config.Bind("Concussion Visuals", "Max Motion Blur Amount", 20f,
            ...
            ConfigEntries.Add(DebugLogging = config.Bind("Debug", "Concussion Debug Logging", true,
